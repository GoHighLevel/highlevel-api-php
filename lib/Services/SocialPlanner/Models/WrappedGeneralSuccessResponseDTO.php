 ...
 */
class WrappedGeneralSuccessResponseDTO
{
    /**
     * @var bool
     */
    ...
    /**
     * @var GeneralSuccessResponseDTO
     */
    public GeneralSuccessResponseDTO $results;
    ...
    public function __construct(array $data = [])
    {
        ...
        // Handle single GeneralSuccessResponseDTO object
        if (isset($data['results']) && is_array($data['results'])) {
            $this->results = new GeneralSuccessResponseDTO($data['results']);
        } else {
