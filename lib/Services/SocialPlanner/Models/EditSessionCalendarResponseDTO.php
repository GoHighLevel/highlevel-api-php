 ...
 */
class EditSessionCalendarResponseDTO
{
    /**
     * @var string|null
     */
    ...
    /**
     * @var array&lt;EditSessionScheduledPostDTO&gt;|null
     */
    ...
    public function __construct(array $data = [])
    {
        ...
        // Handle array of EditSessionScheduledPostDTO objects
        if (isset($data['scheduledPosts']) && is_array($data['scheduledPosts'])) {
            $this->scheduled_posts = array_map(function($item) {
                return is_array($item) ? new EditSessionScheduledPostDTO($item) : $item;
            }, $data['scheduledPosts']);
        } else {
