 ...
 */
class WrappedResetQueueItemResponseDTO
{
    /**
     * @var bool
     */
    ...
    /**
     * @var ResetQueueItemResponseDTO
     */
    public ResetQueueItemResponseDTO $results;
    ...
    public function __construct(array $data = [])
    {
        ...
        // Handle single ResetQueueItemResponseDTO object
        if (isset($data['results']) && is_array($data['results'])) {
            $this->results = new ResetQueueItemResponseDTO($data['results']);
        } else {
