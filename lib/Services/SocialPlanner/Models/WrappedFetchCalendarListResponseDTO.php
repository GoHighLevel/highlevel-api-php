 ...
 */
class WrappedFetchCalendarListResponseDTO
{
    /**
     * @var bool
     */
    ...
    /**
     * @var FetchCalendarListResponseDTO
     */
    public FetchCalendarListResponseDTO $results;
    ...
    public function __construct(array $data = [])
    {
        ...
        // Handle single FetchCalendarListResponseDTO object
        if (isset($data['results']) && is_array($data['results'])) {
            $this->results = new FetchCalendarListResponseDTO($data['results']);
        } else {
