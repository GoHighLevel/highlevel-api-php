 ...
 */
class WrappedStartEditSessionResponseDTO
{
    /**
     * @var bool
     */
    ...
    /**
     * @var StartEditSessionResponseDTO
     */
    public StartEditSessionResponseDTO $results;
    ...
    public function __construct(array $data = [])
    {
        ...
        // Handle single StartEditSessionResponseDTO object
        if (isset($data['results']) && is_array($data['results'])) {
            $this->results = new StartEditSessionResponseDTO($data['results']);
        } else {
