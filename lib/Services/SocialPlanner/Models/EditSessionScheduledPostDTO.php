 ...
 */
class EditSessionScheduledPostDTO
{
    /**
     * @var string|null
     */
     ...
     * @var string|null
     */
    public ?string $original_item_id = null;
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->original_item_id = $data['originalItemId'] ?? null;
    }
    ...
    public function toArray(): array
    {
        ...
        if ($this->original_item_id !== null) {
            $result['originalItemId'] = $this->original_item_id;
        }
        return $result;
    }
}
