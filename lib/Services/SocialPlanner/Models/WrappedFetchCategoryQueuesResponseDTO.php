 ...
 */
class WrappedFetchCategoryQueuesResponseDTO
{
    /**
     * @var bool
     */
    ...
    /**
     * @var FetchCategoryQueuesResponseDTO
     */
    public FetchCategoryQueuesResponseDTO $results;
    ...
    public function __construct(array $data = [])
    {
        ...
        // Handle single FetchCategoryQueuesResponseDTO object
        if (isset($data['results']) && is_array($data['results'])) {
            $this->results = new FetchCategoryQueuesResponseDTO($data['results']);
        } else {
