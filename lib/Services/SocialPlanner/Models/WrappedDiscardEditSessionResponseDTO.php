 ...
 */
class WrappedDiscardEditSessionResponseDTO
{
    /**
     * @var bool
     */
    ...
    /**
     * @var DiscardEditSessionResponseDTO
     */
    public DiscardEditSessionResponseDTO $results;
    ...
    public function __construct(array $data = [])
    {
        ...
        // Handle single DiscardEditSessionResponseDTO object
        if (isset($data['results']) && is_array($data['results'])) {
            $this->results = new DiscardEditSessionResponseDTO($data['results']);
        } else {
