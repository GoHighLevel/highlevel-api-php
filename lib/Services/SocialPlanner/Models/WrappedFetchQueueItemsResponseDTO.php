 ...
 */
class WrappedFetchQueueItemsResponseDTO
{
    /**
     * @var bool
     */
    ...
    /**
     * @var FetchQueueItemsResponseDTO
     */
    public FetchQueueItemsResponseDTO $results;
    ...
    public function __construct(array $data = [])
    {
        ...
        // Handle single FetchQueueItemsResponseDTO object
        if (isset($data['results']) && is_array($data['results'])) {
            $this->results = new FetchQueueItemsResponseDTO($data['results']);
        } else {
