 ...
 */
class WrappedSaveEditSessionResponseDTO
{
    /**
     * @var bool
     */
    ...
    /**
     * @var SaveEditSessionResponseDTO
     */
    public SaveEditSessionResponseDTO $results;
    ...
    public function __construct(array $data = [])
    {
        ...
        // Handle single SaveEditSessionResponseDTO object
        if (isset($data['results']) && is_array($data['results'])) {
            $this->results = new SaveEditSessionResponseDTO($data['results']);
        } else {
