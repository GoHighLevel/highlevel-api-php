 ...
 */
class WrappedCreateCategoryQueueResponseDTO
{
    /**
     * @var bool
     */
    ...
    /**
     * @var CreateCategoryQueueResponseDTO
     */
    public CreateCategoryQueueResponseDTO $results;
    ...
    public function __construct(array $data = [])
    {
        ...
        // Handle single CreateCategoryQueueResponseDTO object
        if (isset($data['results']) && is_array($data['results'])) {
            $this->results = new CreateCategoryQueueResponseDTO($data['results']);
        } else {
