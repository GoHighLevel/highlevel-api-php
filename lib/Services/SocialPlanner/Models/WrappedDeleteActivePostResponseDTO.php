 ...
 */
class WrappedDeleteActivePostResponseDTO
{
    /**
     * @var bool
     */
    ...
    /**
     * @var DeleteActivePostResponseDTO
     */
    public DeleteActivePostResponseDTO $results;
    ...
    public function __construct(array $data = [])
    {
        ...
        // Handle single DeleteActivePostResponseDTO object
        if (isset($data['results']) && is_array($data['results'])) {
            $this->results = new DeleteActivePostResponseDTO($data['results']);
        } else {
