 ...
 */
class WrappedUpdateQueueItemResponseDTO
{
    /**
     * @var bool
     */
    ...
    /**
     * @var UpdateQueueItemResponseDTO
     */
    public UpdateQueueItemResponseDTO $results;
    ...
    public function __construct(array $data = [])
    {
        ...
        // Handle single UpdateQueueItemResponseDTO object
        if (isset($data['results']) && is_array($data['results'])) {
            $this->results = new UpdateQueueItemResponseDTO($data['results']);
        } else {
