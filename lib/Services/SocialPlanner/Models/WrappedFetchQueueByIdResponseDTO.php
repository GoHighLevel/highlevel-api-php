 ...
 */
class WrappedFetchQueueByIdResponseDTO
{
    /**
     * @var bool
     */
    ...
    /**
     * @var FetchQueueByIdResponseDTO
     */
    public FetchQueueByIdResponseDTO $results;
    ...
    public function __construct(array $data = [])
    {
        ...
        // Handle single FetchQueueByIdResponseDTO object
        if (isset($data['results']) && is_array($data['results'])) {
            $this->results = new FetchQueueByIdResponseDTO($data['results']);
        } else {
