...
class CreatedCategoryQueueDTO
{
    ...
    /**
     * @var array&lt;CreatedTimeSlotDTO&gt;|null
     */
    ...
    public function __construct(array $data = [])
    {
        ...
        // Handle array of CreatedTimeSlotDTO objects
        if (isset($data['timeSlots']) && is_array($data['timeSlots'])) {
            $this->time_slots = array_map(function($item) {
                return is_array($item) ? new CreatedTimeSlotDTO($item) : $item;
            }, $data['timeSlots']);
        } else {
