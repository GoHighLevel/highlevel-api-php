 ...
 */
class WrappedUpdateCategoryQueueResponseDTO
{
    /**
     * @var bool
     */
    ...
    /**
     * @var UpdateCategoryQueueResponseDTO
     */
    public UpdateCategoryQueueResponseDTO $results;
    ...
    public function __construct(array $data = [])
    {
        ...
        // Handle single UpdateCategoryQueueResponseDTO object
        if (isset($data['results']) && is_array($data['results'])) {
            $this->results = new UpdateCategoryQueueResponseDTO($data['results']);
        } else {
