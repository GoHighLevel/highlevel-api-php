 ...
 */
class WrappedCloneQueueItemResponseDTO
{
    /**
     * @var bool
     */
    ...
    /**
     * @var CloneQueueItemResponseDTO
     */
    public CloneQueueItemResponseDTO $results;
    ...
    public function __construct(array $data = [])
    {
        ...
        // Handle single CloneQueueItemResponseDTO object
        if (isset($data['results']) && is_array($data['results'])) {
            $this->results = new CloneQueueItemResponseDTO($data['results']);
        } else {
