 ...
 */
class WrappedFetchAvailableCategoriesResponseDTO
{
    /**
     * @var bool
     */
    ...
    /**
     * @var FetchAvailableCategoriesResponseDTO
     */
    public FetchAvailableCategoriesResponseDTO $results;
    ...
    public function __construct(array $data = [])
    {
        ...
        // Handle single FetchAvailableCategoriesResponseDTO object
        if (isset($data['results']) && is_array($data['results'])) {
            $this->results = new FetchAvailableCategoriesResponseDTO($data['results']);
        } else {
