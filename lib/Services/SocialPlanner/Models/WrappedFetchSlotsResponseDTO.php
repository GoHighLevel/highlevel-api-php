 ...
 */
class WrappedFetchSlotsResponseDTO
{
    /**
     * @var bool
     */
    ...
    /**
     * @var FetchSlotsResponseDTO
     */
    public FetchSlotsResponseDTO $results;
    ...
    public function __construct(array $data = [])
    {
        ...
        // Handle single FetchSlotsResponseDTO object
        if (isset($data['results']) && is_array($data['results'])) {
            $this->results = new FetchSlotsResponseDTO($data['results']);
        } else {
