 ...
 */
class WrappedCreateQueueItemResponseDTO
{
    /**
     * @var bool
     */
    ...
    /**
     * @var CreateQueueItemResponseDTO
     */
    public CreateQueueItemResponseDTO $results;
    ...
    public function __construct(array $data = [])
    {
        ...
        // Handle single CreateQueueItemResponseDTO object
        if (isset($data['results']) && is_array($data['results'])) {
            $this->results = new CreateQueueItemResponseDTO($data['results']);
        } else {
