 ...
 */
class ListWorkflowCampaignsPublicV2ResponseDto
{
    /**
     * @var array&lt;WorkflowCampaignPublicV2Dto&gt;
     */
    ...
    {
        // Handle array of WorkflowCampaignPublicV2Dto objects
        if (isset($data['campaigns']) && is_array($data['campaigns'])) {
            $this->campaigns = array_map(function($item) {
                return is_array($item) ? new WorkflowCampaignPublicV2Dto($item) : $item;
            }, $data['campaigns']);
        } else {
