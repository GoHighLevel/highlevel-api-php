...
class IBuilderJsonMapper
{
     ...
     */
    public TemplateSettings $template_settings;
    ...
    public function __construct(array $data = [])
    {
        ...
        // Handle single TemplateSettings object
        if (isset($data['templateSettings']) && is_array($data['templateSettings'])) {
            $this->template_settings = new TemplateSettings($data['templateSettings']);
        } else {
