...
{
    /**
     * @var InboundDndSettingSchema|null
     */
    public ?InboundDndSettingSchema $all = null;
    ...
    {
        // Handle single InboundDndSettingSchema object
        if (isset($data['all']) && is_array($data['all'])) {
            $this->all = new InboundDndSettingSchema($data['all']);
        } else {
