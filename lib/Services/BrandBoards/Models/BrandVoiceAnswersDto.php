...
class BrandVoiceAnswersDto
{
     ...
     * @var string
     */
    public string $customer_pain_points;
    ...
    public function __construct(array $data = [])
    {
        ...
        $this->tone_of_voice = $data['toneOfVoice'] ?? '';
        $this->target_audience = $data['targetAudience'] ?? '';
        $this->customer_pain_points = $data['customerPainPoints'] ?? '';
