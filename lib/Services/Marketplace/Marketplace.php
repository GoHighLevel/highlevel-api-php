...
namespace HighLevel\Services\Marketplace;
...
use HighLevel\Services\Marketplace\Models\RaiseChargeBodyDTO;
 ...
 * 
 * @package HighLevel\Services\Marketplace
 */
class Marketplace
{
    /**
     ...
     * Create a new wallet charge
     * 
     * @param RaiseChargeBodyDTO $requestBody Request body data
    ...
    public function charge(
        ...
        $url = RequestUtils::buildUrl('/marketplace/billing/charges', $extracted['path']);
     ...
     * 
     * @param array{
     *   chargeId: string // ID of the charge to delete
     * } $params Request parameters
     * @param array<string, mixed>|null $options Additional request options
     * @return mixed Response data
     * @throws GHLError
    ...
    public function deleteCharge(
        ...
        $url = RequestUtils::buildUrl('/marketplace/billing/charges/{chargeId}', $extracted['path']);
    ...
    public function hasFunds(
        ...
        $url = RequestUtils::buildUrl('/marketplace/billing/charges/has-funds', $extracted['path']);
     ...
     * 
     * @param array{
     *   appId: string // The application id which is to be uninstalled.
     * } $params Request parameters
     * @param DeleteIntegrationBodyDto $requestBody Request body data
     * @param array<string, mixed>|null $options Additional request options
     * @return DeleteIntegrationResponse Response data
     * @throws GHLError
     * @throws GuzzleException
     */
    public function uninstallApplication(
        ...
        try {
            ...
            return new DeleteIntegrationResponse($responseData);
        } catch (RequestException $e) {
            $statusCode = $e->hasResponse() ? $e->getResponse()->getStatusCode() : null;
            $responseBody = $e->hasResponse() ? (string) $e->getResponse()->getBody() : null;
            $responseData = $responseBody ? json_decode($responseBody, true) : null;
     ...
     * 
     * @param array{
     *   appId: string // ID of the app to get installer details
     * } $params Request parameters
     * @param array<string, mixed>|null $options Additional request options
     * @return GetInstallerDetailsResponseDTO Response data
     * @throws GHLError
     * @throws GuzzleException
     */
