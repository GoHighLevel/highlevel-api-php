 ...
 */
class ListSubscriptionResponseDto
{
    /**
     * @var array&lt;SubscriptionResponseSchema&gt;
     */
    public array $data;
    ...
    {
        // Handle array of SubscriptionResponseSchema objects
        if (isset($data['data']) && is_array($data['data'])) {
            $this->data = array_map(function($item) {
                return is_array($item) ? new SubscriptionResponseSchema($item) : $item;
            }, $data['data']);
        } else {
            $this->data = $data['data'] ?? [];
        }
