...
class UpdateServiceDTO
{
    ...
    /**
     * @var array&lt;StaffDTO&gt;|null
     */
    public ?array $staff = null;

    /**
     * @var array&lt;UpdateServiceVariationDTO&gt;|null
     */
    ...
    public function __construct(array $data = [])
    {
        ...
        // Handle array of UpdateServiceVariationDTO objects
        if (isset($data['variations']) && is_array($data['variations'])) {
            $this->variations = array_map(function($item) {
                return is_array($item) ? new UpdateServiceVariationDTO($item) : $item;
            }, $data['variations']);
        } else {
