...
namespace HighLevel\Services\Campaigns;
...
use HighLevel\Services\Campaigns\Models\CampaignsSuccessfulResponseDto;

/**
 * Campaigns Service
 * Documentation for campaigns API
 * 
 * @package HighLevel\Services\Campaigns
 */
class Campaigns
{
    /**
    ...
    /**
     * Create a new Campaigns service instance
     * 
     ...
     * @return CampaignsSuccessfulResponseDto Response data
     * @throws GHLError
    ...
    public function getCampaigns(
        ...
        $paramDefs = [['name' => 'locationId', 'in' => 'query'], ['name' => 'status', 'in' => 'query']];
        $extracted = RequestUtils::extractParams($params, $paramDefs);
        $requirements = ["bearer"];

        $url = RequestUtils::buildUrl('/campaigns/', $extracted['path']);
        ...
        try {
            ...
            return new CampaignsSuccessfulResponseDto($responseData);
